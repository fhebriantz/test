...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new com.azha.android.lastri.PreferenceManager(this).checkPreference())
        {
            loadHome();
        }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            ...
            case R.id.bnSkip:
                loadHome();
                new com.azha.android.lastri.PreferenceManager(this).writePreference();
                break;
        }
